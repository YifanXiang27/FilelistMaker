...
int main(int argc, char **argv){
    ...
    while(infile>>read){
        ...
        if(samplename.find("20UL16NanoAODAPVv9") != string::npos){
        ...
        else if(samplename.find("20UL16NanoAODv9") != string::npos){
        ...
        else if(samplename.find("20UL17NanoAODv9") != string::npos){
        ...
        else if(samplename.find("20UL18NanoAODv9") != string::npos){
